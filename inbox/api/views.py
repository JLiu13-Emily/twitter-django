...
class NotificationViewSet(
    ...
    def get_queryset(self):
        #return self.request.user.notifications.all()  Django 的反查机制
    ...
    def update(self, request, *args, **kwargs):
        ...
        的一次更新操作，所以直接重载 update 的方法来实现。另外一种实现方法是用一个专属的action:
            ...
            def mark_as_unread(self, request, *args, **kwargs):
               ....
            两种方法都可以，我更偏好重载 update， 因为更通用更 rest 一些，而且 mark_as_unread和
