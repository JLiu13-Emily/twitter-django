...
class Like(models.Model):
    # http://docs.djangoproject.com/en/3.1/ref/contrib/bontenttypes/#generic-relations
    ...
    class Meta:
        ...
        # 的索引， 这个索引同时还可以具备查询某个 user like 了哪些不同的objects的功能
        # 因此如果 unique together 改成 <content_type, object_id, user>
        # 就没有这样的效果了
        unique_together = (('user', 'content_type', 'object_id'),)
        # 这个 index 的作用是可以按时间顺序某个被 like 的 content_object 的所有likes
        index_together = (
