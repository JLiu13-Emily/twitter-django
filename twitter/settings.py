...
SECRET_KEY = 'pz-z8a#gy+uu&nvz0_v*6_!s#$nh-n16c-)l+q#1)cw4ujn=a2'
...
AWS_STORAGE_BUCKET_NAME = 'django-twitter13'
AWS_S3_REGION_NAME = 'us-west-1'

# 你还需要在local_settings.py 中设置你的 AWS_ACCESS_KEY_ID 和 AWS_SECRET_ACCESS_KEY
# 因为这是比较机密的信息，是不适合放在 settings.py 这种共享的配置文件中共享给所有开发者的
# 真是的开发场景下，可以使用 local_settings.py 的方式，或者设置在环境变量里的方式
