...
class TweetApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user2 = self.create_user('user2', 'uesr2@jiuzhang.com')
        self.tweets2 = [
    ...
    def test_retrieve(self):
        ...
        self.create_comment(self.user2, tweet, 'wonderful world')
    ...
    def test_create_with_files(self):
        ...
        # 上传单个文件
        # content 需要时一个bytes 类型，所以用 str.encode 转换一下
